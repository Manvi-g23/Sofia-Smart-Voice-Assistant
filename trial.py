...
def set_reminder(input_mode="speech"):
    ...
    speak("When should I remind you? Please specify the time in the format HH:MM (24-hour format).")
...
if __name__ == "__main__":
    authenticate()
    input_mode = input("Choose input mode ('speech' or 'text'): ").strip().lower()
    taskexecution(input_mode)
